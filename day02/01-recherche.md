...
**Ma réponse :  Les boucles while et for sont toutes deux utilisées pour exécuter des instructions de manière répétitive, mais elles diffèrent dans leur syntaxe et leur utilisation;
la boucle 'for' Utilise lorsque vous savez combien de fois vous devez itérer; 
la boucle 'while' utilise lorsque cela dépend d'une condition dynamique.
**
